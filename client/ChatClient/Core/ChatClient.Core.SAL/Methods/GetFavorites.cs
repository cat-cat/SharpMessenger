...
{
 public   class GetFavorites:Request<Dictionary<string, object>>
    {

        private readonly string _target = "favorites";
        ...
        public async override Task<Dictionary<string, object>> Object()
        {
            ...
            try
            {
                ...
                string favorites = (string)Response.ResponseObject["favorites"]["docs"].ToString();
                string pageCount = Response.ResponseObject["favorites"]["pages"].ToString();
                string filePrefix = Response.ResponseObject["filePrefix"].ToString();
                lDictionary = new Dictionary<string, object>() {
                                                                                      {"groups", JsonConvert.DeserializeObject<List<Group>>(favorites) },
        ...
        public GetFavorites(string token, int pageNumber, int pageSize, string orderBy)
        {
